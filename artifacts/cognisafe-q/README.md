# CogniSafe-Q - Architecture & File Structure

CogniSafe-Q is a modern mobile vehicular safety and emergency response application built with **React Native**, **Expo (Expo Router)**, and **TypeScript**.
