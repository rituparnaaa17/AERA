...
export default function AboutScreen() {
  ...
  const appName = (Constants.expoConfig?.name as string | undefined) ?? 'Cognisafe-Q';
      ...
      >
        ...
        <View style={styles.brandCard}>
          ...
          <Text style={styles.brand}>
            {appName.split('-')[0] || 'Cognisafe'}
            <Text style={styles.brandAccent}>-Q</Text>
          </Text>
        ...
        <View style={styles.descCard}>
          ...
          <View style={{ flex: 1, gap: 4 }}>
            ...
            <Text style={styles.descBody}>
              Cognisafe-Q monitors driving behaviour, detects potential risks
        ...
        <Text style={styles.footer}>© Cognisafe-Q · Built with Expo & React Native.</Text>
      </ScrollView>
    </AppBackground>
  );
}
